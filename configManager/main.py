...
structure.config['templates']['tv']['configure_series']['settings']['from']['trakt_list']['username'] = user
structure.config['templates']['tv']['configure_series']['settings']['from']['trakt_list']['list'] = list
